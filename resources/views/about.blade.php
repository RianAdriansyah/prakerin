...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/frontend/styles/about.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('assets/frontend/styles/about_responsive.css') }}">
</head>
<body>
...
<div class="super_container">
			...
			<div class="row">
				...
				<div class="col-lg-6 intro_col">
					<div class="intro_image">
						<img src="{{ asset('assets/frontend/images/about_intro.jpg') }}" alt="https://unsplash.com/@rawpixel">
					</div>
				</div>
	...
	<div class="boxes d-flex flex-md-row align-items-start justify-content-start flex-wrap">
		...
		<div class="box d-flex flex-column align-items-center justify-content-center">
			<div class="box_content d-flex flex-row align-items-center justify-content-start">
				<div class="box_icon"><img src="{{ asset('assets/frontend/images/icon_1.svg') }}" alt="https://www.flaticon.com/authors/freepik"></div>
				<div class="box_text">
		...
		<div class="box d-flex flex-column align-items-center justify-content-center">
			<div class="box_content d-flex flex-row align-items-center justify-content-start">
				<div class="box_icon"><img src="{{ asset('assets/frontend/images/icon_2.svg') }}" alt="https://www.flaticon.com/authors/freepik"></div>
				<div class="box_text">
		...
		<div class="box d-flex flex-column align-items-center justify-content-center">
			<div class="box_content d-flex flex-row align-items-center justify-content-start">
				<div class="box_icon"><img src="{{ asset('assets/frontend/images/icon_3.svg') }}" alt="https://www.flaticon.com/authors/freepik"></div>
				<div class="box_text">
		...
		<div class="box d-flex flex-column align-items-center justify-content-center">
			<div class="box_content d-flex flex-row align-items-center justify-content-start">
				<div class="box_icon"><img src="{{ asset('assets/frontend/images/icon_4.svg') }}" alt="https://www.flaticon.com/authors/freepik"></div>
				<div class="box_text">
	...
	<div class="milestones">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="{{ asset('assets/frontend/images/milestones.jpg') }}" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				...
				<div class="col-xl-3 col-md-6 milestone_col">
					<div class="milestone d-flex flex-row align-items-center justify-content-center">
						<div class="milestone_icon d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('assets/frontend/images/icon_5.svg') }}" alt=""></div>
				...
				<div class="col-xl-3 col-md-6 milestone_col">
					<div class="milestone d-flex flex-row align-items-center justify-content-center">
						<div class="milestone_icon d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('assets/frontend/images/icon_6.svg') }}" alt=""></div>
						<div class="milestone_content">
				...
				<div class="col-xl-3 col-md-6 milestone_col">
					<div class="milestone d-flex flex-row align-items-center justify-content-center">
						<div class="milestone_icon d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('assets/frontend/images/icon_7.svg') }}" alt=""></div>
						<div class="milestone_content">
				...
				<div class="col-xl-3 col-md-6 milestone_col">
					<div class="milestone d-flex flex-row align-items-center justify-content-center">
						<div class="milestone_icon d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('assets/frontend/images/icon_8.svg') }}" alt=""></div>
						<div class="milestone_content">
...
<script src="{{ asset('assets/frontend/js/about.js') }}"></script>
</body>
</html>